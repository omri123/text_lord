...
def yelp_generator(csv_path, max_examples=10000):
...
class DataFrameDataset(data.Dataset):
    ...
    def __init__(self, example_generator, id_field, stars_field, review_field, is_test=False, **kwargs):
        fields = [('id', id_field), ('stars', stars_field), ('review', review_field)]
        examples = []
        for example in tqdm(example_generator):
